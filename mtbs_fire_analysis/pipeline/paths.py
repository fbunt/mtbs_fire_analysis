...
ROOT_TMP_DIR = MAIN_FOLDER_ALIAS / "data_tmp" # Path("/var/mnt/fastdata01/fire_tmp/")
RESULTS_DIR = MAIN_FOLDER_ALIAS / "data" / "results" #Path("/var/mnt/fastdata02/mtbs/results")
