...
burnt = engine.burn(ignition_xy=ignition,
                    fuel=fuel,
                    rain_mask_iter=rain_gen,
                    wind_iter=zip(fire_wind_u, fire_wind_v, strict=False))

collector.flush_to_mp4(Path("CA_Simulation/outputs") / "single_fire16.mp4")
print("single_fire16.mp4 written")
